...
recorder Element -file $dataDir/ForceEle_$FirstColumn$_aBID.out -time -ele $FirstColumn localForce;				# element forces in local coordinates
recorder Element -file $dataDir/ForceEle_sec_1_$FirstColumn$_aBID.out -time -ele $FirstColumn section 1 force;	# section forces, axial and moment, node i
recorder Element -file $dataDir/DefoEle_sec_1_$FirstColumn$_aBID.out -time -ele $FirstColumn section 1 deformation;	# section deformations, axial and curvature, node i
recorder Element -file $dataDir/ForceEle_sec$_numIntgrPts_$FirstColumn$_aBID.out -time -ele $FirstColumn section $numIntgrPts force;	# section forces, axial and moment, node j
recorder Element -file $dataDir/DefoEle_sec$_numIntgrPts_$FirstColumn$_aBID.out -time -ele $FirstColumn section $numIntgrPts deformation;# section deformations, axial and curvature, node j
...
recorder Element -file $dataDir/StressStrain_concEle_sec_1_$FirstColumn$_aBID.out -time -ele $FirstColumn section $numIntgrPts fiber $yFiber $zFiber $IDconcCore  stressStrain;	# Core Concrete stress-strain, node i
recorder Element -file $dataDir/StressStrain_reinfEle_sec_1_$FirstColumn$_aBID.out -time -ele $FirstColumn section $numIntgrPts fiber $yFiber $zFiber $IDSteel  stressStrain;	# steel fiber stress-strain, node i

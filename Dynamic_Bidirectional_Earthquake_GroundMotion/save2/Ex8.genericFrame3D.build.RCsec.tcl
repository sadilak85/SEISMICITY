      ...
      foreach line [split [read $inFileID] \n] {
         if {[llength $line] == 0} {
			...
			foreach word [split $line] {
				if {[string match $word "#BUILDING_END"] == 1} {
					set ainputFilename($Buildingnum) $outputFilename$Buildingnum$outputFileExt
...
set checkID 0
set numInFile 1
if [catch {open $ainputFilename($numInFile) r} inFileID] {
	puts stderr "Cannot open $inFilename for reading"
} else {
  set flag 0
	foreach line [split [read $inFileID] \n] {
